...
// Fib Circles: concentric rings around a center dot, echoing the tool's
// center + fib-ratio-radius rings.
function FibCirclesIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" fill="none">
...
// Fib Wedge: two edges from a corner apex with fib-ratio arcs curving
// between them — Fib Circles clipped to a wedge.
function FibWedgeIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" fill="none">
      <line x1="3" y1="21" x2="21" y2="21" />
      <line x1="3" y1="21" x2="15.7" y2="8.3" />
      <path d="M21 21a18 18 0 0 0-5.3-12.7" />
      <path d="M14 21a11 11 0 0 0-3.2-7.8" strokeWidth="1" />
      <path d="M8.5 21a5.5 5.5 0 0 0-1.6-3.9" strokeWidth="1" />
      <circle cx="3" cy="21" r="1.5" fill="currentColor" stroke="none" />
    </svg>
  );
}

// Pitchfan: rays fanning from an anchor point toward a base line, the
// middle (median) ray emphasized.
function PitchfanIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" fill="none">
      <line x1="19" y1="3" x2="19" y2="21" strokeWidth="1" />
      <line x1="3" y1="12" x2="21" y2="12" />
      <line x1="3" y1="12" x2="21" y2="3" strokeWidth="1" />
      <line x1="3" y1="12" x2="21" y2="7.5" strokeWidth="1" />
      <line x1="3" y1="12" x2="21" y2="16.5" strokeWidth="1" />
      <line x1="3" y1="12" x2="21" y2="21" strokeWidth="1" />

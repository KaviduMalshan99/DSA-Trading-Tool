...
| Replay & Practice                                                  | 🟡 **In progress** _(Session 33)_ — Layer 1 done: replay engine + candlestick playback (pick a start bar, play/pause/step/speed, clean live restore); Layer 2 (overlays respect replay-time) not started |
